# ColPulse | Radiografia de 2026-09

**Executive summary**
El monitor consolida 40 indicadores oficiales de Colombia con datos disponibles hasta 2026-09-06. La base combina senales de precios, actividad, mercado laboral, sector externo, condiciones financieras y mercados. La lectura ejecutiva debe distinguir hechos observados, inferencias razonables e hipotesis pendientes de validacion; ningun resultado modelado se presenta como dato oficial.

## Insights clave

### Insight 1
El dolar se mantuvo estable: cerro en 3,126 pesos por dolar, con un cambio de 0 pesos por dolar frente al dato anterior.

### Insight 2
La tasa de politica monetaria se mantuvo estable: cerro en 12.00%, con un cambio de 0.00% frente al dato anterior.

### Insight 3
El COLCAP subio: cerro en 2,436.94 puntos, con un cambio de 141.66 puntos frente al dato anterior.

## Grafico principal
![Indicador principal](main_chart.png)
